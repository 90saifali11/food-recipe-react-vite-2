              ...
              <Link to={`/detail/${recipe.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                <div style={{ padding: '15px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontSize: '14px', color: '#666' }}> <img src="https://firebasestorage.googleapis.com/v0/b/first-project-e823d.appspot.com/o/recipes%2Fnoun-calories-7053265.png?alt=media&token=dc253fcf-f08a-4015-89fa-d2bd01ac5fe9" style={{width:"20px"}} alt="" />{recipe.caloriesPerServing || recipe.calories} cals</span>
                  </div>
                </div>
